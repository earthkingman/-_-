...
@login_decorator
@transaction.atomic
    def deposit(self, authenticated_member: Member, account_number: str, deal_amount: int, description: str) -> Tuple[
        int, DealHistory]:
        ...
        created_deal_history = self.__create_deal_history(deal_amount, description, found_account, result_balance,
                                                          DealHistory.DealType.DEPOSIT)
